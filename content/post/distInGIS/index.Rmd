...
hex_bay <- st_make_grid(bay, cellsize = 250, square = F)
```

```{r plot5, echo=FALSE, warning=FALSE, fig.align="center", eval=TRUE}
par(mar = c(3, 3, 1, 1))
plot(st_geometry(bay), axes = T, main = "", col = "#E2E2E2", border = "#C1C1C1")
plot(hex_bay, col = "#FFFFFF00", border = "#0300FF", add = T)
