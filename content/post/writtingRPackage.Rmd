...
As I have recently submitted a first package to the [CRAN](https://cran.r-project.org/) after quite a while I'd like
to share my expereince and took the opportunity to revisit a piece of text I wrote
three years ago when I built y forst package. 
