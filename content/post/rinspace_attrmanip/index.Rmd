...
```{r manualSub}
spatDataSub <- spatData[1:10, ]
plot(spatData[, 'var1'], col = 'blue')
plot(spatDataSub[, 'var1'], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)
```
...
spatDataSub <- spatData[spatData$var1 >= 0, ]
plot(spatData[, 1], col = 'blue')
plot(spatDataSub[, 1], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)

# var1 smaller than 0 and var2 higher than 5
spatDataSub <- spatData[spatData$var1 < 0 & spatData$var2 < 5, ]
plot(spatData[, 1], col = 'blue')
plot(spatDataSub[, 1], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)

# fact1 equal to a1
spatDataSub <- spatData[spatData$fact1 == 'a1', ]
plot(spatData[, 1], col = 'blue')
plot(spatDataSub[, 1], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)

# fact1 equal to a1 or var1 greater than 0
spatDataSub <- spatData[spatData$fact1 == 'a1' | spatData$var1 > 0, ]
plot(spatData[, 1], col = 'blue')
plot(spatDataSub[, 1], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)

# fact2 equal to b3 or b4
spatDataSub <- spatData[spatData$fact2 %in% c('b3','b4'), ]
plot(spatData[, 1], col = 'blue')
plot(spatDataSub[, 1], col = 'black', add = T, pch = 4, cex = 2, lwd = 2)
```
