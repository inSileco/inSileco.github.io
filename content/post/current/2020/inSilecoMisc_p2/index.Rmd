...
frame (or a list of data frames) in document of various formats. I actually
created
...
As I mentioned above `tblDown()` handles lists of data frames and the user can also pass a set of captions for every table and even separates them with section headers (of level 1).
