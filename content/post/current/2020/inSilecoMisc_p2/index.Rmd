...
scripts, I like having information and a nice clear visual reported and that is why I value packages such as
...
building a package, I created four simple message functions using `r url_cran("crayon")` and `r url_cran("cli")` <!-- avoid things like latter when referencing sentences earlier in a paragraph, it forces the reader to go back and read it again to make sure he understands what you are writing -->
