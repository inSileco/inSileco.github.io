...
matured functions in the research compendium of recent manuscripts (see the
following <i class="fa fa-github" aria-hidden="true"></i> repositories:
...
Note that in this case, lengths of output strings may differ!
...
cat(loremIpsum())
```
but it also allows the user to choose a number of words:
