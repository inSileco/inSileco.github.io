---
title: Disturbance Ecology Series - Continuous Exponential Growth
author: [david]
reviewer:
date: 2018-07-02
...
draft: true
tweet: "Disturbance Ecology Series - Continuous Exponential Growth"
estime: 15
relativeurls: true
...
In the [first post](`r htmltools::HTML("{{< ref DensityIndependentGrowth >}}")`)
...
[first post](`r htmltools::HTML("{{< ref DensityIndependentGrowth >}}")`)
...
text(x = 12, y = 39, TeX("$r \\, > \\, 0$"), cex = 1, adj = 0)
text(x = 12, y = 37, TeX("$r = 0$"), cex = 1, adj = 0)
text(x = 12, y = 35, TeX("$r \\, < \\, 0$"), cex = 1, adj = 0)
```
