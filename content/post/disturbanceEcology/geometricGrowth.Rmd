...
<!-- For this plot in particular (though I would always start these kind of plots at t0), I think you need to start at t0. I really get hung up on the fact that the lines don't start at the same point! 

Also, I don't know what the answer to this really is, but what does a population of 0.3125 mean? Can you have a fraction of an organism? Should we just start with a larger number and round to avoid the issue?-->
...
<!-- made this more colorblind friendly and thickened the lines for my old tired eyes ;), I will let you decide which of these changes to keep and/or to apply to other plots -->
