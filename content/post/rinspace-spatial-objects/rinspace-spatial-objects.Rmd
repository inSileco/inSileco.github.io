---
title: "Spatial data"
author: [nicolas, kevin, david, marie-helene, elliot]
date: 2018-04-02
tags: [Spatial, R]
...
cd ~/Documents/inSileco.github.io/
...
corse  <- readRDS("corse-admin.rds")
rivers <- readRDS("corse-rivers.rds")
cities <- readRDS("corse-cities.rds")
...
corse      <- readRDS("corse-admin.rds")
elevation  <- readRDS("corse-elevation.rds")
landcover  <- readRDS("corse-landcover.rds")
occurrence <- readRDS("corse-occurrence.rds")
