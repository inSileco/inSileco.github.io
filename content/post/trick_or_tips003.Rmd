...
A very useful way to look for a function you barely remember the names without
googling it.
...
You can also take advantage from the regular expression to narrow down you research:
...
This could actually be very helpful. For instance when we are tested whether
...
If you often create empty data.frame, you very likely about the about the
...
But if you are looking for unique combinations (think about all combination of
...
do.call(rbind, combn(LETTERS[1:5], 2, simplify=F))
