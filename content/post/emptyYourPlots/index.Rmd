...
The power is even more with all the package that take advanage from the JS
ibrabry, for instance [plotly](https://plot.ly/r/), [DiagrammR](http://rich-iannone.github.io/DiagrammeR/), [NetworkD3](https://christophergandrud.github.io/networkD3/), [Wordcloud2](https://cran.r-project.org/web/packages/wordcloud2/vignettes/wordcloud.html), etc.


There are many many different solutions to create graph [see our wiki page
