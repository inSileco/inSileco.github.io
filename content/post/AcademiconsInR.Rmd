...
<i class="fa fa-edit" aria-hidden="true"></i>November 11, 2017 -- Fix paths to icon files.
<i class="fa fa-edit" aria-hidden="true"></i>February 14, 2017 -- Make it work with version 5 of Fontawesome
