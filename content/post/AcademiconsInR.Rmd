...
```{r addfont}
font_add(family = 'Academicons', regular = paste0(path,'/Academicons.ttf'))
font_add(family = 'FontAwesome', regular = paste0(path,'/FontAwesome.otf'))
font_add(family = 'Ionicons', regular = paste0(path,'/Ionicons.ttf'))
```
