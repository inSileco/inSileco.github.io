...
```{r addfont}
font.add(family = 'Academicons', regular = paste0(path,'/Academicons.ttf'))
font.add(family = 'FontAwesome', regular = paste0(path,'/FontAwesome.otf'))
font.add(family = 'Ionicons', regular = paste0(path,'/Ionicons.ttf'))
```
...
![Academicons on LibreOffice](/assets/AcademiconsInR/academicons.png){width=80%}
