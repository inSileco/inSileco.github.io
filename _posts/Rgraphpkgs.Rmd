...
author:
  - Kevin Cazelles,
    ...
    Steve Vissault &
    David Beauchesne
date: "December 4, 2015 -  last update on June 25, 2017`"
status: published
output:
  html_document:
    include:
...
Note that the list of packages below would be updated as soon as we find a new package.
If you know a package that should be in the list, please feel mention it in the disqus section that follows the list.  
...
```{r rgrappkgs, echo=FALSE, results="asis"}
  source("Rscripts/rGraphPkgs.R")
```
