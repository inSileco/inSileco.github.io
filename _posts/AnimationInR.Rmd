---
title: "Animations in R \n Time series of erythemal irradiance in the St. Lawrence"
author:
  - David Beauchesne
status: draft
...
```{r, include = FALSE}
rm(list=ls())
setwd("/Users/davidbeauchesne/Dropbox/PhD/letir.github.io") # À enlever
library(raster)
library(magrittr)
library(plyr)
library(animation)
